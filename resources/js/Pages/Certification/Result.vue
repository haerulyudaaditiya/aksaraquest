...
const downloadCertificate = () => {
    if (certificateElement.value) {
        ...
        html2canvas(certificateElement.value, {
            scale: 2,
            useCORS: true,
            backgroundColor: null, // biar hasil PNG transparan dan bersih
        }).then((canvas) => {
...
<template>
    ...
    <div class="min-h-screen bg-slate-200 flex flex-col items-center justify-center p-4 sm:p-6 text-center">
        <div ref="certificateElement" class="w-full max-w-4xl bg-[#FDFBF5] rounded-lg shadow-2xl p-8 relative overflow-hidden">
            ...
            <div class="relative z-10">
                <p class="text-sm font-semibold text-amber-800 uppercase tracking-[0.2em]">
                ...
                <p class="font-signature text-7xl text-slate-900 my-6 border-b-2 border-slate-200 pb-6">
                    {{ user.name }}
                </p>
                ...
                <div class="flex justify-around items-end mt-12">
                    <div class="text-center">
                        <p class="font-bold text-slate-700">{{ formattedDate }}</p>
                        <hr class="border-slate-800 mt-2" />
                        <p class="text-sm text-slate-500">Tanggal Kelulusan</p>
                    </div>

                    <div class="relative">
                        <svg class="h-28 w-28 text-red-800" viewBox="0 0 100 100">
                            <path
                                fill="currentColor"
                    ...
                    <div class="text-center">
                        <p class="font-bold text-slate-700">{{ attempt.score }} / 100</p>
                        <hr class="border-slate-800 mt-2" />
        ...
        <div class="mt-8 flex items-center gap-4">
            ...
            <Link :href="route('dashboard')" class="font-semibold text-slate-600 hover:text-indigo-600">
