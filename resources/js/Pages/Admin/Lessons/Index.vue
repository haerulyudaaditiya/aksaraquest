            ...
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <div class="mb-6 text-right">
                    <Link :href="route('admin.lessons.create')">
                        <PrimaryButton class="w-full justify-center sm:w-auto">Tambah Pelajaran Baru</PrimaryButton>
                    </Link>
                </div>
                            ...
                            <table class="min-w-full">
                                <thead class="border-b-2 border-slate-800">
                                    <tr>
                                        ...
                                        <th class="text-left p-3 font-extrabold text-slate-900 whitespace-nowrap">Bab</th>
                                        <th class="text-left p-3 font-extrabold text-slate-900 whitespace-nowrap">Urutan</th>
                                ...
                                <tbody v-if="lessons.length > 0">
                                    <tr v-for="lesson in lessons" :key="lesson.id" class="border-b border-slate-200 hover:bg-slate-50">
                                        ...
                                        <td class="p-3 text-slate-600 whitespace-nowrap">{{ lesson.chapter.title }}</td>
                                        <td class="p-3 font-bold whitespace-nowrap">{{ lesson.order }}</td>
