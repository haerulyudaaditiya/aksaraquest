            ...
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <div class="mb-6 sm:text-right">
                    <Link :href="route('admin.stories.create')">
                        <PrimaryButton class="w-full justify-center sm:w-auto">Tambah Dongeng Baru</PrimaryButton>
                    </Link>
                </div>
                <div
                            ...
                            <table class="min-w-full">
                                <thead class="border-b-2 border-slate-800">
                                    <tr>
                                        ...
                                        <th
                                            class="text-left p-3 font-extrabold text-slate-900 whitespace-nowrap"
                                        >
                                            Urutan
                                        </th>
                                        <th
                                ...
                                <tbody v-if="stories.length > 0">
                                    <tr
                                        v-for="story in stories"
                                        :key="story.id"
                                        class="border-b border-slate-200 hover:bg-slate-50"
                                    >
                                        <td class="p-3 font-bold text-lg min-w-[200px]">
                                            {{ story.title }}
                                        </td>
