...
const deleteItem = () => {
    router.delete(route("admin.aksara.destroy", itemToDelete.value.id), {
    ...
    <Modal :show="confirmingDeletion" @close="closeModal">
        ...
        >
            <div class="flex items-start gap-4">
                <div
                    class="flex-shrink-0 bg-red-100 p-3 rounded-xl border-2 border-slate-800"
                >
                    <svg
                ...
                <div>
                    ...
                    <p class="mt-2 text-slate-600">
                        Anda yakin ingin menghapus aksara
                        <span class="font-bold font-sunda"
                            >{{ itemToDelete?.character }} ({{
                                itemToDelete?.latin
                            }})</span
                        >? Tindakan ini tidak dapat diurungkan dan akan
